...
with st.sidebar:
    selected = option_menu(None, ["Home","Upload & Extract","Modify"], 
                       ...
                       styles={"nav-link": {"font-size": "20px", "text-align": "centre", "margin": "-2px", "--hover-color": "#6495ED"},
...
if selected == "Home":
        ...
        st.markdown("## :orange[**Overview :**] This Streamlit web app facilitates the extraction of pertinent details from uploaded business card images using easyOCR. Users can subsequently view, edit, or remove the extracted information. Additionally, the app enables users to save this information, along with the respective business card image, in a database capable of storing multiple entries.")
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            with open(os.path.join(filepath, uploaded_card.name), "wb") as f:
    ...
    # DISPLAYING THE CARD WITH HIGHLIGHTS
        with col2:
            ...
            with st.spinner("Please wait processing image..."):
                ...
                saved_img = os.path.join(filepath, uploaded_card.name)
...
# MODIFY MENU   
if selected == "Modify":
    tab1,tab2,tab3=st.tabs(["Update or Modify","Delete Data","View Updated Data"])  
